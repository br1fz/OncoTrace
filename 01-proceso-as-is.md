...
- 🚪 **Interrupciones críticas por demanda espontánea presencial:** Alta concurrencia de pacientes (oncológicos y no oncológicos o en sospecha) que acuden presencialmente a la oficina exigiendo información sobre sus biopsias e informes; bajo el amparo de la Ley Nacional del Cáncer N° 21.258 no se les puede negar la atención, lo que colapsa y atrasa el trabajo de navegación de casos de las gestoras (afecta al Gestor y al Paciente).
